...
fun generateKotlin(pkg: String, allPackages: Sequence<String>, interfaces: List<GenerateTraitOrClass>, unions: GenerateUnionTypes, enums: List<EnumDefinition>): String {
    ...
    return kotlinHeader(pkg, allPackages) +
            ...
            if (pkg == "org.w3c.dom") {
                "public fun getDocument(): Document = DocumentImpl(ArenaManager.globalArena, pushDocumentToArena(ArenaManager.globalArena))\n"+
                "public fun getWindow(): Window = WindowImpl(ArenaManager.globalArena, pushWindowToArena(ArenaManager.globalArena))\n"
            } else ""
}
